...
class Seminar(models.Model):
    ...
    def get_update_url(self):
        return urls.reverse_lazy('seminar:update', args=[self.slug])

    def get_delete_url(self):
        return urls.reverse_lazy('seminar:delete', args=[self.slug])

    def get_detail_url(self):
        return urls.reverse_lazy('seminar:detail', args=[self.slug])
    
    def get_stream_url(self):
        return urls.reverse_lazy('seminar:stream', args=[self.slug])
